...
class GameJsonEncoderTest extends \PHPUnit_Framework_TestCase{
	...
	public function testGetEncodedObject(){
		$expectedJson = '{"id":null,"name":"Arizona","noPlayers":2,"state":2,"players":[{"id":null,"username":"ricardo75","flipType":1,"flipTypeAsString":"heads"},{"id":null,"username":"flipshark","flipType":2,"flipTypeAsString":"tails"}]}';
		$game = $this->setUpGame();
